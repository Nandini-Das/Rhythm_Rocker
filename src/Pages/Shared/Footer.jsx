        ...
        <>
            <footer className="footer p-10  bg-neutral text-neutral-content">
                <div>
                    ...
                    <p>Rhythm Rocker <br />Providing reliable tech since 1992</p>
                </div>
                <div>
            ...
            <footer className="footer footer-center p-4  bg-neutral-800 text-neutral-content">
                <div>
                    <small>Copyright © 2023 - All right reserved by Rhythm Rocker</small>
                </div>
            </footer>
        </>
